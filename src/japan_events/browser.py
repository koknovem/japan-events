...
() => {
  ...
  const DATE_RE = /(\d{4}\s*[年./-]\s*\d{1,2}\s*[月./-]\s*\d{1,2}|\d{4}[-/]\d{1,2}[-/]\d{1,2}|[A-Z][a-z]{2,9}\s+\d{1,2}(?:st|nd|rd|th)?,?\s+\d{4}|\d{1,2}\s+[A-Z][a-z]{2,9}\s+\d{4}|\d{1,2}\s*月\s*\d{1,2}\s*日)/;
  const RANGE_RE = /((?:\d{1,2}\s+[A-Z][a-z]{2,9}(?:,?\s+\d{4})?|[A-Z][a-z]{2,9}\s+\d{1,2}(?:st|nd|rd|th)?(?:,?\s+\d{4})?|\d{4}[-/.]\d{1,2}[-/.]\d{1,2}|\d{1,2}[-/]\d{1,2})\s*[-–~〜～to]+\s*(?:\d{1,2}\s+[A-Z][a-z]{2,9}(?:,?\s+\d{4})?|[A-Z][a-z]{2,9}\s+\d{1,2}(?:st|nd|rd|th)?(?:,?\s+\d{4})?|\d{4}[-/.]\d{1,2}[-/.]\d{1,2}|\d{1,2}[-/]\d{1,2}(?:\s+\d{4})?))/i;
